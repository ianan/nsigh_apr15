pro plot_map_cb_igh, prange, bottom, ncolors, cb_title=cb_title, log=log, $
  charsize=charsize, position=position, color=color, format=format,_extra=extra
  
  ; Plot a nice colour table
  ; modified version of plot_map_cb_igh.pro (add more control options that work)
